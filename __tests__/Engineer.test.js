...
describe('Name', () => {
    it('Should consist of letters.',()=>{
        const name = "Joe";
        const e = new Engineer(name,123,"email@email.com","Engineer", "github");
...
describe('ID', ()=>{
    it('Should consist of Numbers.',()=>{
        const id = 123;
        const e = new Engineer("Joe",id,"email@email.com","Engineer", "github");
        expect(e.id).toBe(id);
    });
...
describe('Email', ()=>{
    it('Should have an email input.',()=>{
        ...
        const e = new Engineer("Joe",123,email,"Engineer", "github");
...
describe('GitHub', ()=>{
    it('Should return user github username.', ()=>{
        const github = "github";
        const e = new Engineer("Joe",123,"email@email.com","Engineer", github);
